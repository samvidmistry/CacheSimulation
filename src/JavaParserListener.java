...
public interface JavaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#cachePolicy}.
	 * @param ctx the parse tree
	 */
	void enterCachePolicy(JavaParser.CachePolicyContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#cachePolicy}.
	 * @param ctx the parse tree
	 */
	void exitCachePolicy(JavaParser.CachePolicyContext ctx);
	/**
